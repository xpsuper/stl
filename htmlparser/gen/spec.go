...
func parseSpec(file io.Reader) *Spec {
	root, err := htmlparser.Parse(file)
	c(err)
...
func parseAttributeTable(root *htmlparser.Node) *AttributeTable {
...
func parseElementTable(root *htmlparser.Node, attrTable *AttributeTable) *ElementTable {
