...
func (dc *Context) DrawUnicodeStringWrapped(s string, x, y, ax, ay, width, lineSpacing float64, align Align) {
	lines := dc.WordUnicodeWrap(s, width)
...
func (dc *Context) WordUnicodeWrap(s string, w float64) []string {
	return wordUnicodeWrap(dc, s, w)
}
